...
class OrderViewSet(ModelViewSet):
    ...
    def get_queryset(self):
        ...
        if user.is_staff:
            return Order.objects.prefetch_related('orderitems__product').select_related('customer').all()
        customer_id = Customer.objects.only('id').get(user_id=user.id)
        return Order.objects.prefetch_related('orderitems__product').select_related('customer').filter(customer_id=customer_id)
